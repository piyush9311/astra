...
class LoginStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Size size = Size(MediaQuery.of(context).size.width, MediaQuery.of(context).size.height);
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            width:MediaQuery.of(context).size.width/2 - MediaQuery.of(context).size.width*0.025,
            child:Row(
